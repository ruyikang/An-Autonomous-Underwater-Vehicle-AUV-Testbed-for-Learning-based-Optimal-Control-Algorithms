    ...
    while isOpened:
        ...
        for i, cnt in enumerate(contours):
            ...
            if (cX > int(min_area_rect[0][0])) and (cY >= int(min_area_rect[0][1])): # 重心在右下，矩阵中心在左上,方向左上
                #print("重心右下，中心左上")
                # cv2.putText(canvas, str("重心右下，中心左上"), (40, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255),
                #             2)
            ...
            elif (cX > int(min_area_rect[0][0])) and (cY < int(min_area_rect[0][1])): # 重心在右上，矩阵中心在左下,方向左下
                #print("重心右上，中心左下")
                # cv2.putText(canvas, "重心右上，中心左下", (40, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255),
                #             2)
                ...
                #cv2.arrowedLine(canvas, (x, y), (2 * x - center_x, 2 * y - center_y)
                #                , color=(0, 255, 255), thickness=2, line_type=8, shift=0, tipLength=0.05)
            elif (cX < int(min_area_rect[0][0])) and (cY >= int(min_area_rect[0][1])):  # 重心在左下，矩阵中心在右上，方向右上
                #print("重心左下，中心右上")
                # cv2.putText(canvas, "重心左下，中心右上", (40, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255),
                #             2)
                yaw_actual1 = int(theta1) - 90
                ...
                # print("重心左上，中心右下")
                # cv2.putText(canvas, "重心左上，中心右下", (40, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255),
                #             2)
